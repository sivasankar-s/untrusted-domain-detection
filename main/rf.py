...
def load_data(train_path, test_path, label_column='Label', num_buckets=1000000):
...
def train_random_forest_model(X_train, y_train, n_estimators=100, max_depth=None, random_state=42):
...
rf_model = train_random_forest_model(X_train, y_train, n_estimators=100, max_depth=None, random_state=42)
accuracy, precision, recall, f1 = evaluate_model(rf_model, X_test, y_test, label_encoder)
